...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(KC_BTN1, TOP2, TOP3, TOP4, TOP5, TOP6, TOP7, TOP8, TOP9, TOP10, TOP11, TOP12, KC_BTN2, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, BOT10, BOT11, BOT12, THU1, THU2, THU3, THU4, THU5, THU6),
    [1] = LAYOUT(KC_BTN1, STN_S1, STN_TL, STN_PL, STN_HL, STN_ST1, STN_ST3, STN_FR, STN_PR, STN_LR, STN_TR, STN_DR, KC_BTN2, STN_S2, STN_KL, STN_WL, STN_RL, STN_ST2, STN_ST4, STN_RR, STN_BR, STN_GR, STN_SR, STN_ZR, STN_N1, STN_A, STN_O, STN_E, STN_U, STN_N2),
    [2] = LAYOUT(KC_BTN1, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN3, KC_BTN2, KC_BTN1, KC_BTN1, KC_BTN2, KC_BTN3),
    [3] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_WH_U, KC_BSPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LGUI, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_WH_D, KC_DEL, KC_LALT, KC_LCTL, KC_LSFT, KC_BTN1, KC_BTN2, KC_BTN3),
};
size_t keymapsCount = 4;
...
const struct Chord chord_0 PROGMEM = {H_TOP6 + H_TOP7 + H_BOT6 + H_BOT7, ALWAYS_ON, &state_0, NULL, 0, 0, reset};
uint8_t state_1 = IDLE;
const struct Chord chord_1 PROGMEM = {H_BOT6 + H_BOT7, ALWAYS_ON, &state_1, NULL, _PLOVER, 0, switch_layer};
...
const struct Chord chord_13 PROGMEM = {H_TOP2 + H_BOT2, QWERTY, &state_13, NULL, KC_A, KC_LSFT, key_mod_dance};
uint8_t state_14 = IDLE;
uint8_t counter_14 = 0;
const struct Chord chord_14 PROGMEM = {H_TOP3 + H_BOT3, QWERTY, &state_14, &counter_14, KC_S, KC_LALT, key_key_dance};
uint8_t state_15 = IDLE;
uint8_t counter_15 = 0;
const struct Chord chord_15 PROGMEM = {H_TOP4 + H_BOT4, QWERTY, &state_15, &counter_15, KC_D, KC_LGUI, key_key_dance};
uint8_t state_16 = IDLE;
const struct Chord chord_16 PROGMEM = {H_TOP5 + H_BOT5, QWERTY, &state_16, NULL, KC_F, KC_LCTL, key_mod_dance};
uint8_t state_17 = IDLE;
const struct Chord chord_17 PROGMEM = {H_TOP6 + H_BOT6, QWERTY, &state_17, NULL, KC_G, KC_LSFT, key_mod_dance};
uint8_t state_18 = IDLE;
const struct Chord chord_18 PROGMEM = {H_TOP7 + H_BOT7, QWERTY, &state_18, NULL, KC_H, KC_RSFT, key_mod_dance};
uint8_t state_19 = IDLE;
const struct Chord chord_19 PROGMEM = {H_TOP8 + H_BOT8, QWERTY, &state_19, NULL, KC_J, KC_RCTL, key_mod_dance};
uint8_t state_20 = IDLE;
uint8_t counter_20 = 0;
const struct Chord chord_20 PROGMEM = {H_TOP9 + H_BOT9, QWERTY, &state_20, &counter_20, KC_K, KC_RGUI, key_key_dance};
uint8_t state_21 = IDLE;
uint8_t counter_21 = 0;
const struct Chord chord_21 PROGMEM = {H_TOP10 + H_BOT10, QWERTY, &state_21, &counter_21, KC_L, KC_RALT, key_key_dance};
uint8_t state_22 = IDLE;
const struct Chord chord_22 PROGMEM = {H_TOP11 + H_BOT11, QWERTY, &state_22, NULL, KC_SCOLON, 0, single_dance};
uint8_t state_23 = IDLE;
const struct Chord chord_23 PROGMEM = {H_TOP12 + H_BOT12, QWERTY, &state_23, NULL, KC_QUOTE, 0, single_dance};
uint8_t state_24 = IDLE;
const struct Chord chord_24 PROGMEM = {H_BOT2, QWERTY, &state_24, NULL, KC_Z, KC_LCTL, key_mod_dance};
uint8_t state_25 = IDLE;
const struct Chord chord_25 PROGMEM = {H_BOT3, QWERTY, &state_25, NULL, KC_X, 0, single_dance};
uint8_t state_26 = IDLE;
const struct Chord chord_26 PROGMEM = {H_BOT4, QWERTY, &state_26, NULL, KC_C, 0, single_dance};
uint8_t state_27 = IDLE;
const struct Chord chord_27 PROGMEM = {H_BOT5, QWERTY, &state_27, NULL, KC_V, 0, single_dance};
uint8_t state_28 = IDLE;
const struct Chord chord_28 PROGMEM = {H_BOT6, QWERTY, &state_28, NULL, KC_B, 0, single_dance};
uint8_t state_29 = IDLE;
const struct Chord chord_29 PROGMEM = {H_BOT7, QWERTY, &state_29, NULL, KC_N, 0, single_dance};
uint8_t state_30 = IDLE;
const struct Chord chord_30 PROGMEM = {H_BOT8, QWERTY, &state_30, NULL, KC_M, 0, single_dance};
uint8_t state_31 = IDLE;
const struct Chord chord_31 PROGMEM = {H_BOT9, QWERTY, &state_31, NULL, KC_COMMA, 0, single_dance};
uint8_t state_32 = IDLE;
const struct Chord chord_32 PROGMEM = {H_BOT10, QWERTY, &state_32, NULL, KC_DOT, 0, single_dance};
uint8_t state_33 = IDLE;
const struct Chord chord_33 PROGMEM = {H_BOT11, QWERTY, &state_33, NULL, KC_SLASH, 0, single_dance};
uint8_t state_34 = IDLE;
const struct Chord chord_34 PROGMEM = {H_BOT12, QWERTY, &state_34, NULL, KC_ENT, 0, single_dance};
uint8_t state_35 = IDLE;
const struct Chord chord_35 PROGMEM = {H_THU1, QWERTY, &state_35, NULL, NUM, 0, temp_pseudolayer};
uint8_t state_36 = IDLE;
const struct Chord chord_36 PROGMEM = {H_THU2, QWERTY, &state_36, NULL, KC_TAB, KC_LCTL, key_mod_dance};
uint8_t state_37 = IDLE;
const struct Chord chord_37 PROGMEM = {H_THU3, QWERTY, &state_37, NULL, KC_SPACE, KC_LSFT, key_mod_dance};
uint8_t state_38 = IDLE;
uint8_t counter_38 = 0;
const struct Chord chord_38 PROGMEM = {H_THU4, QWERTY, &state_38, &counter_38, KC_SPACE, KC_RGUI, key_key_dance};
uint8_t state_39 = IDLE;
uint8_t counter_39 = 0;
const struct Chord chord_39 PROGMEM = {H_THU5, QWERTY, &state_39, &counter_39, KC_ENTER, KC_LALT, key_key_dance};
uint8_t state_40 = IDLE;
const struct Chord chord_40 PROGMEM = {H_THU6, QWERTY, &state_40, NULL, NUM, 0, temp_pseudolayer};
uint8_t state_41 = IDLE;
const struct Chord chord_41 PROGMEM = {H_TOP2 + H_TOP3 + H_TOP4 + H_TOP5, QWERTY, &state_41, NULL, NAV, 0, temp_pseudolayer};
uint8_t state_42 = IDLE;
const struct Chord chord_42 PROGMEM = {H_TOP6 + H_BOT6, QWERTY, &state_42, NULL, MOUSE, 0, temp_pseudolayer};
uint8_t state_43 = IDLE;
const struct Chord chord_43 PROGMEM = {H_TOP7 + H_BOT7, QWERTY, &state_43, NULL, MOUSE, 0, temp_pseudolayer};
uint8_t state_44 = IDLE;
const struct Chord chord_44 PROGMEM = {H_BOT5 + H_BOT8, QWERTY, &state_44, NULL, KC_ENTER, 0, single_dance};
uint8_t state_45 = IDLE;
const struct Chord chord_45 PROGMEM = {H_TOP7 + H_TOP12, QWERTY, &state_45, NULL, KC_DEL, 0, single_dance};
uint8_t state_46 = IDLE;
const struct Chord chord_46 PROGMEM = {H_TOP2, NUM, &state_46, NULL, KC_1, 0, single_dance};
uint8_t state_47 = IDLE;
const struct Chord chord_47 PROGMEM = {H_TOP3, NUM, &state_47, NULL, KC_2, 0, single_dance};
uint8_t state_48 = IDLE;
const struct Chord chord_48 PROGMEM = {H_TOP4, NUM, &state_48, NULL, KC_3, 0, single_dance};
uint8_t state_49 = IDLE;
const struct Chord chord_49 PROGMEM = {H_TOP5, NUM, &state_49, NULL, KC_4, 0, single_dance};
uint8_t state_50 = IDLE;
const struct Chord chord_50 PROGMEM = {H_TOP6, NUM, &state_50, NULL, KC_5, 0, single_dance};
uint8_t state_51 = IDLE;
const struct Chord chord_51 PROGMEM = {H_TOP7, NUM, &state_51, NULL, KC_6, 0, single_dance};
uint8_t state_52 = IDLE;
const struct Chord chord_52 PROGMEM = {H_TOP8, NUM, &state_52, NULL, KC_7, 0, single_dance};
uint8_t state_53 = IDLE;
const struct Chord chord_53 PROGMEM = {H_TOP9, NUM, &state_53, NULL, KC_8, 0, single_dance};
uint8_t state_54 = IDLE;
const struct Chord chord_54 PROGMEM = {H_TOP10, NUM, &state_54, NULL, KC_9, 0, single_dance};
uint8_t state_55 = IDLE;
const struct Chord chord_55 PROGMEM = {H_TOP11, NUM, &state_55, NULL, KC_0, 0, single_dance};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_TOP12, NUM, &state_56, NULL, KC_MINUS, 0, single_dance};
uint8_t state_57 = IDLE;
const struct Chord chord_57 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_57, NULL, KC_LALT, 0, single_dance};
uint8_t state_58 = IDLE;
const struct Chord chord_58 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_58, NULL, KC_LGUI, 0, single_dance};
uint8_t state_59 = IDLE;
const struct Chord chord_59 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_59, NULL, KC_LCTL, 0, single_dance};
uint8_t state_60 = IDLE;
const struct Chord chord_60 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_60, NULL, KC_LSFT, 0, single_dance};
uint8_t state_61 = IDLE;
const struct Chord chord_61 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_61, NULL, KC_RSFT, 0, single_dance};
uint8_t state_62 = IDLE;
const struct Chord chord_62 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_62, NULL, KC_RCTL, 0, single_dance};
uint8_t state_63 = IDLE;
const struct Chord chord_63 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_63, NULL, KC_RGUI, 0, single_dance};
uint8_t state_64 = IDLE;
const struct Chord chord_64 PROGMEM = {H_TOP10 + H_BOT10, NUM, &state_64, NULL, KC_F11, 0, single_dance};
uint8_t state_65 = IDLE;
const struct Chord chord_65 PROGMEM = {H_TOP11 + H_BOT11, NUM, &state_65, NULL, KC_F12, 0, single_dance};
uint8_t state_66 = IDLE;
const struct Chord chord_66 PROGMEM = {H_BOT2, NUM, &state_66, NULL, KC_F1, 0, single_dance};
uint8_t state_67 = IDLE;
const struct Chord chord_67 PROGMEM = {H_BOT3, NUM, &state_67, NULL, KC_F2, 0, single_dance};
uint8_t state_68 = IDLE;
const struct Chord chord_68 PROGMEM = {H_BOT4, NUM, &state_68, NULL, KC_F3, 0, single_dance};
uint8_t state_69 = IDLE;
const struct Chord chord_69 PROGMEM = {H_BOT5, NUM, &state_69, NULL, KC_F4, 0, single_dance};
uint8_t state_70 = IDLE;
const struct Chord chord_70 PROGMEM = {H_BOT6, NUM, &state_70, NULL, KC_F5, 0, single_dance};
uint8_t state_71 = IDLE;
const struct Chord chord_71 PROGMEM = {H_BOT7, NUM, &state_71, NULL, KC_F6, 0, single_dance};
uint8_t state_72 = IDLE;
const struct Chord chord_72 PROGMEM = {H_BOT8, NUM, &state_72, NULL, KC_F7, 0, single_dance};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_BOT9, NUM, &state_73, NULL, KC_F8, 0, single_dance};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_BOT10, NUM, &state_74, NULL, KC_F9, 0, single_dance};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_BOT11, NUM, &state_75, NULL, KC_F10, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_BOT12, NUM, &state_76, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_77 = IDLE;
const struct Chord chord_77 PROGMEM = {H_THU2, NUM, &state_77, NULL, KC_LCTL, 0, single_dance};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_THU3, NUM, &state_78, NULL, KC_LSFT, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_THU4, NUM, &state_79, NULL, KC_RGUI, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_THU5, NUM, &state_80, NULL, KC_RALT, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_TOP2, FNC, &state_81, NULL, KC_F1, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_TOP3, FNC, &state_82, NULL, KC_F2, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_TOP4, FNC, &state_83, NULL, KC_F3, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_TOP5, FNC, &state_84, NULL, KC_F4, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_TOP6, FNC, &state_85, NULL, KC_F5, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_TOP7, FNC, &state_86, NULL, KC_F6, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_TOP8, FNC, &state_87, NULL, KC_F7, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_TOP9, FNC, &state_88, NULL, KC_F8, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_TOP10, FNC, &state_89, NULL, KC_F9, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_TOP11, FNC, &state_90, NULL, KC_F10, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_TOP12, FNC, &state_91, NULL, KC_F11, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_TOP3 + H_BOT3, FNC, &state_92, NULL, KC_LALT, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_TOP4 + H_BOT4, FNC, &state_93, NULL, KC_LCTL, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_TOP5 + H_BOT5, FNC, &state_94, NULL, KC_LSFT, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_TOP6 + H_BOT6, FNC, &state_95, NULL, KC_LGUI, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_TOP7 + H_BOT7, FNC, &state_96, NULL, KC_RGUI, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_TOP8 + H_BOT8, FNC, &state_97, NULL, KC_RSFT, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_TOP9 + H_BOT9, FNC, &state_98, NULL, KC_RCTL, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_TOP10 + H_BOT10, FNC, &state_99, NULL, KC_RALT, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_BOT12, FNC, &state_100, NULL, KC_F12, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_TOP8 + H_TOP9 + H_TOP10, NAV, &state_101, NULL, KC_HOME, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_BOT8 + H_BOT9 + H_BOT10, NAV, &state_102, NULL, KC_END, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_TOP8, NAV, &state_103, NULL, KC_HOME, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_TOP9, NAV, &state_104, NULL, KC_UP, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_TOP10, NAV, &state_105, NULL, KC_END, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_TOP11, NAV, &state_106, NULL, KC_PGUP, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_TOP12, NAV, &state_107, NULL, KC_BSPC, 0, single_dance};
uint8_t state_108 = IDLE;
const struct Chord chord_108 PROGMEM = {H_TOP3 + H_BOT3, NAV, &state_108, NULL, KC_LALT, 0, single_dance};
uint8_t state_109 = IDLE;
const struct Chord chord_109 PROGMEM = {H_TOP4 + H_BOT4, NAV, &state_109, NULL, KC_LCTL, 0, single_dance};
uint8_t state_110 = IDLE;
const struct Chord chord_110 PROGMEM = {H_TOP5 + H_BOT5, NAV, &state_110, NULL, KC_LSFT, 0, single_dance};
uint8_t state_111 = IDLE;
const struct Chord chord_111 PROGMEM = {H_TOP6 + H_BOT6, NAV, &state_111, NULL, KC_LGUI, 0, single_dance};
uint8_t state_112 = IDLE;
const struct Chord chord_112 PROGMEM = {H_TOP12 + H_BOT12, NAV, &state_112, NULL, KC_DEL, 0, single_dance};
uint8_t state_113 = IDLE;
const struct Chord chord_113 PROGMEM = {H_BOT8, NAV, &state_113, NULL, KC_LEFT, 0, single_dance};
uint8_t state_114 = IDLE;
const struct Chord chord_114 PROGMEM = {H_BOT9, NAV, &state_114, NULL, KC_DOWN, 0, single_dance};
uint8_t state_115 = IDLE;
const struct Chord chord_115 PROGMEM = {H_BOT10, NAV, &state_115, NULL, KC_RIGHT, 0, single_dance};
uint8_t state_116 = IDLE;
const struct Chord chord_116 PROGMEM = {H_BOT11, NAV, &state_116, NULL, KC_PGDN, 0, single_dance};
uint8_t state_117 = IDLE;
const struct Chord chord_117 PROGMEM = {H_THU2, NAV, &state_117, NULL, KC_LCTL, 0, single_dance};
uint8_t state_118 = IDLE;
const struct Chord chord_118 PROGMEM = {H_THU3, NAV, &state_118, NULL, KC_LSFT, 0, single_dance};
uint8_t state_119 = IDLE;
const struct Chord chord_119 PROGMEM = {H_TOP5 + H_TOP8 + H_BOT2 + H_BOT3 + H_BOT4 + H_BOT10, NAV, &state_119, NULL, KC_TAB, 0, single_dance};
uint8_t state_120 = IDLE;
const struct Chord chord_120 PROGMEM = {H_TOP5 + H_TOP8 + H_BOT2 + H_BOT3 + H_BOT4 + H_BOT10 + H_THU4, NAV, &state_120, NULL, KC_BACKSPACE, 0, single_dance};
uint8_t state_121 = IDLE;
const struct Chord chord_121 PROGMEM = {H_TOP5 + H_TOP8 + H_BOT2 + H_BOT3 + H_BOT4 + H_BOT10 + H_THU5, NAV, &state_121, NULL, KC_DELETE, 0, single_dance};
uint8_t state_122 = IDLE;
const struct Chord chord_122 PROGMEM = {H_TOP5 + H_TOP8 + H_BOT2 + H_BOT3 + H_BOT4 + H_BOT10 + H_THU4 + H_THU5, NAV, &state_122, NULL, KC_ESCAPE, 0, single_dance};
uint8_t state_123 = IDLE;
const struct Chord chord_123 PROGMEM = {H_TOP8, MOUSE, &state_123, NULL, KC_BTN1, 0, single_dance};
uint8_t state_124 = IDLE;
const struct Chord chord_124 PROGMEM = {H_TOP9, MOUSE, &state_124, NULL, KC_MS_U, 0, single_dance};
uint8_t state_125 = IDLE;
const struct Chord chord_125 PROGMEM = {H_TOP10, MOUSE, &state_125, NULL, KC_BTN2, 0, single_dance};
uint8_t state_126 = IDLE;
const struct Chord chord_126 PROGMEM = {H_TOP11, MOUSE, &state_126, NULL, KC_WH_U, 0, single_dance};
uint8_t state_127 = IDLE;
const struct Chord chord_127 PROGMEM = {H_TOP3 + H_BOT3, MOUSE, &state_127, NULL, KC_LALT, 0, single_dance};
uint8_t state_128 = IDLE;
const struct Chord chord_128 PROGMEM = {H_TOP4 + H_BOT4, MOUSE, &state_128, NULL, KC_LCTL, 0, single_dance};
uint8_t state_129 = IDLE;
const struct Chord chord_129 PROGMEM = {H_TOP5 + H_BOT5, MOUSE, &state_129, NULL, KC_LSFT, 0, single_dance};
uint8_t state_130 = IDLE;
const struct Chord chord_130 PROGMEM = {H_TOP6 + H_BOT6, MOUSE, &state_130, NULL, KC_LGUI, 0, single_dance};
uint8_t state_131 = IDLE;
const struct Chord chord_131 PROGMEM = {H_BOT8, MOUSE, &state_131, NULL, KC_MS_L, 0, single_dance};
uint8_t state_132 = IDLE;
const struct Chord chord_132 PROGMEM = {H_BOT9, MOUSE, &state_132, NULL, KC_MS_D, 0, single_dance};
uint8_t state_133 = IDLE;
const struct Chord chord_133 PROGMEM = {H_BOT10, MOUSE, &state_133, NULL, KC_MS_R, 0, single_dance};
uint8_t state_134 = IDLE;
const struct Chord chord_134 PROGMEM = {H_BOT11, MOUSE, &state_134, NULL, KC_WH_D, 0, single_dance};

const struct Chord* const list_of_chords[] PROGMEM = {
    &chord_0, &chord_1, &chord_2, &chord_3, &chord_4, &chord_5, &chord_6, &chord_7, &chord_8, &chord_9, &chord_10, &chord_11, &chord_12, &chord_13, &chord_14, &chord_15, &chord_16, &chord_17, &chord_18, &chord_19, &chord_20, &chord_21, &chord_22, &chord_23, &chord_24, &chord_25, &chord_26, &chord_27, &chord_28, &chord_29, &chord_30, &chord_31, &chord_32, &chord_33, &chord_34, &chord_35, &chord_36, &chord_37, &chord_38, &chord_39, &chord_40, &chord_41, &chord_42, &chord_43, &chord_44, &chord_45, &chord_46, &chord_47, &chord_48, &chord_49, &chord_50, &chord_51, &chord_52, &chord_53, &chord_54, &chord_55, &chord_56, &chord_57, &chord_58, &chord_59, &chord_60, &chord_61, &chord_62, &chord_63, &chord_64, &chord_65, &chord_66, &chord_67, &chord_68, &chord_69, &chord_70, &chord_71, &chord_72, &chord_73, &chord_74, &chord_75, &chord_76, &chord_77, &chord_78, &chord_79, &chord_80, &chord_81, &chord_82, &chord_83, &chord_84, &chord_85, &chord_86, &chord_87, &chord_88, &chord_89, &chord_90, &chord_91, &chord_92, &chord_93, &chord_94, &chord_95, &chord_96, &chord_97, &chord_98, &chord_99, &chord_100, &chord_101, &chord_102, &chord_103, &chord_104, &chord_105, &chord_106, &chord_107, &chord_108, &chord_109, &chord_110, &chord_111, &chord_112, &chord_113, &chord_114, &chord_115, &chord_116, &chord_117, &chord_118, &chord_119, &chord_120, &chord_121, &chord_122, &chord_123, &chord_124, &chord_125, &chord_126, &chord_127, &chord_128, &chord_129, &chord_130, &chord_131, &chord_132, &chord_133, &chord_134
};

const uint16_t** const leader_triggers PROGMEM = NULL;
void (*leader_functions[]) (void) = {};

#define NUMBER_OF_CHORDS 135
