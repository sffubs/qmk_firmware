...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    (
     ...
     /**/                              MT(MOD_LCTL, KC_TAB), MT(MOD_LSFT, KC_SPC),      MT(MOD_RSFT, KC_SPC), LT(_SYMBOL, KC_ENT),
    ...
    [_SYMBOL] = LAYOUT(
     KC_GRV,  KC_NO, KC_NO, KC_NO, KC_NO,     /**/ S(KC_9),    S(KC_0),    S(KC_MINS), S(KC_EQL), S(KC_SCLN), KC_BSPC,
     KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO,     /**/ S(KC_LBRC), S(KC_RBRC), KC_MINS,    KC_EQL,    KC_NUHS,    S(KC_QUOT),
     KC_NUBS, KC_NO, KC_NO, KC_NO, KC_NO,     /**/ KC_LBRC,    KC_RBRC,    S(KC_COMM), S(KC_DOT), KC_NO,      KC_NO,
                            KC_TRNS, KC_TRNS,      KC_TRNS,    KC_TRNS,
                            KC_TRNS, KC_TRNS,      KC_TRNS,    KC_TRNS,
                            KC_TRNS, KC_TRNS,      KC_TRNS,    KC_TRNS
		       ),
